package lzz.mybatis.demo.hello.service;

import lzz.mybatis.demo.hello.dao.UserDao;
import lzz.mybatis.demo.hello.model.User;
...
public class UserService {
    ...
    public void changemoney() {
     ...
     public  User getUserLzz(){

        return  userDao.findByUserNamelzz("Daisy");
     }
}
